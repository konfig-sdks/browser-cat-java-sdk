...
public class BadRequestError {
 ...
 public enum ErrorEnum {
   ...
   */
  @JsonAdapter(InvalidEnum.Adapter.class)
 public enum InvalidEnum {
    ...
    public static InvalidEnum fromValue(String value) {
      for (InvalidEnum b : InvalidEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<InvalidEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final InvalidEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public InvalidEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return InvalidEnum.fromValue(value);
      }
    }
  }
  ...
  private List<BadRequestErrorFieldsInner> fields = null;

  public BadRequestError() {
  }

  public BadRequestError status(StatusEnum status) {
  ...
  **/
  ...
  public BadRequestError error(ErrorEnum error) {
  ...
  **/
  ...
  public BadRequestError invalid(InvalidEnum invalid) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Where the validation error occurred")
  ...
  public void setInvalid(InvalidEnum invalid) {
  ...
  public BadRequestError fields(List<BadRequestErrorFieldsInner> fields) {
  ...
  public BadRequestError addFieldsItem(BadRequestErrorFieldsInner fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Validation errors, when available")

  public List<BadRequestErrorFieldsInner> getFields() {
    return fields;
  }


  public void setFields(List<BadRequestErrorFieldsInner> fields) {
   ...
   * @return the BadRequestError instance itself
   */
  public BadRequestError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, badRequestError.status) &&
        Objects.equals(this.error, badRequestError.error) &&
        Objects.equals(this.message, badRequestError.message) &&
        Objects.equals(this.invalid, badRequestError.invalid) &&
        Objects.equals(this.fields, badRequestError.fields)&&
        Objects.equals(this.additionalProperties, badRequestError.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, error, message, invalid, fields, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BadRequestError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BadRequestError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : BadRequestError.openapiRequiredFields) {
      ...
      if ((jsonObj.get("invalid") != null && !jsonObj.get("invalid").isJsonNull()) && !jsonObj.get("invalid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `invalid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("invalid").toString()));
      }
      if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull()) {
        ...
        if (jsonArrayfields != null) {
          ...
          for (int i = 0; i < jsonArrayfields.size(); i++) {
            BadRequestErrorFieldsInner.validateJsonObject(jsonArrayfields.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BadRequestError>() {
           ...
           public BadRequestError read(JsonReader in) throws IOException {
             ...
             BadRequestError instance = thisAdapter.fromJsonTree(jsonObj);

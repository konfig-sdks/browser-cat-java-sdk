...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.browsercat.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("jwtCookie", new ApiKeyAuth("cookie", "__SESSION"));
        authentications.put("jwtHeader", new HttpBearerAuth("bearer"));
        authentications.put("keyHeader", new ApiKeyAuth("header", "Api-Key"));
        ...
        if (configuration != null) {
            if (configuration.jwtCookie != null) {
                this.setJwtCookie(configuration.jwtCookie);
            }
            if (configuration.keyHeader != null) {
                this.setKeyHeader(configuration.keyHeader);
            }
    ...
    public String getJwtCookie() {
        return ((ApiKeyAuth) this.getAuthentication("jwtCookie")).getApiKey();
    }

    public void setJwtCookie(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("jwtCookie")).setApiKey(apiKey);
    }

    public void setJwtCookiePrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("jwtCookie")).setApiKeyPrefix(prefix);
    }
    public String getKeyHeader() {
        return ((ApiKeyAuth) this.getAuthentication("keyHeader")).getApiKey();
    }

    public void setKeyHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("keyHeader")).setApiKey(apiKey);
    }

    public void setKeyHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("keyHeader")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.browsercat.com)
